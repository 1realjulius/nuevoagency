      ...
      <div className="px-4 md:px-16 pt-10">
        <div className="pt-2">
          <div className="md:py-10">
            <h1 className="text-4xl md:text-7xl md:pr-20 font-FredokaOneRegular pt-4 pb-4 uppercase">
              ...
              <motion.div key={Catslide.id}>
                {index === currentCategory && (
                  <motion.div className="grid md:grid-cols-2 gap-4">
                    {/* texts */}
                    <motion.div className="text-white text-xl flex flex-col space-y-2 items-start justify-between h-full">
                      {/* cat link and btn */}
                      ...
                      <motion.div className="">
                        <h1 className="text-3xl md:text-6xl uppercase text-black">
                      ...
                      <div className="flex flex-row items-center justify-between w-full">
                        ...
                        <div className="py-2">
                          <Link href={Catslide.catLink}>
                            <motion.div className="px-3 py-1 md:px-5 md:py-2 bg-white text-black rounded-full cursor-pointer text-xl flex flex-row items-center space-x-2">
                              <h1>View</h1>
                              <h1 className="flex flex-row items-center space-x-2">
                                <span>{Catslide.catSection}</span>
                                <span>{Catslide.catIcon}</span>
                              </h1>
                            </motion.div>
                          </Link>
                        </div>
                      ...
                      <motion.div className="flex flex-col items-center justify-center">
                        <motion.div className="">
                          <motion.img
                            ...
                            alt="Category Image"
                            className="object-cover w-[90vw] h-[34vh] md:h-[50vh] rounded-xl"
                          />
                        </motion.div>
                      </motion.div>
                    </motion.div>
