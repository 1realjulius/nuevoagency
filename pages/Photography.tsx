...
const Photography = () => {
  ...
  return (
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular z-20 relative">
      ...
      {/* heder */}
      <motion.div className=" inset-x-0 px-4 md:px-16 pt-16 flex flex-col items-center justify-center text-center  w-full py-2 pb-6 -z-20">
      ...
      <div className=" px-4 md:px-16 flex flex-col pt-8 py-4 md:pt-20 space-y-12">
