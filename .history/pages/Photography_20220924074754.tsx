      ...
      <div>
        ...
        <div>
          <div className="flex flex-row items-center py-20">
            ...
            <div className="flex-1 p-10">
              <div className="relative w-[200px] h-[400px] flex flex-col justify-center">
                <div>
                  <Image
                    src="/Assets/moonrise.png"
                    layout="fill"
                ...
                <div className="relative -left-40 -bottom-6 w-[200px] h-[400px]">
                  <Image
                    src="/Assets/moonrise.png"
                    layout="fill"
                    alt=""
                    className=" absolute object-cover"
                  />
                  <div className="relative -left-40 -bottom-6 w-[400px] h-[400px]">
                    <Image
                      src="/Assets/moonrise.png"
                      layout="fill"
                      alt=""
