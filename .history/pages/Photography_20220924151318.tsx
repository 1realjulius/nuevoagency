...
const Photography = () => {
  ...
  return (
    <div className="relative bg-[#161719] min-h-screen min-w-full text-white overflow-hidden">
      {/* navbar */}
      ...
      <div>
        ...
        <div className="grid grid-cols-4">
          <div className=" w-40 h-20 border flex flex-col items-center justify-center">
            <div>
              <h1>100+</h1>
            </div>
            <div>
