    ...
    <div className="bg-[#161719] min-h-screen min-w-full text-white font-FredokaOneRegular">
      ...
      <div className="px-4 pt-8">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-2 md:grid-cols-10 md:justify-between pb-10 md:px-20">
        ...
        <div className="bg-red-300">
          <div className="flex flex-row justify-between px-10 text-lg md:text-6xl md:px-40">
            <div>
