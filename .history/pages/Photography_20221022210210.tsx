...
const Photography = () => {
  ...
  let y = useTransform(scrollYProgress, [0, 10], ["0%", "100%"]);
  return (
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular z-50 relative">
      {/* navbar */}
      ...
      {/* main  */}
      <motion.div className="px-4 md:px-16 pt-16 -z-0">
        {/* heder */}
        ...
        {/* footer */}
        <motion.div style={{ y }} className="absolute bottom-0 inset-x-0 -z-10">
          <NewFooter />
        </motion.div>
      </motion.div>
    </div>
