...
const Photography = () => {
  ...
  const [currentFeatureImage, setCurrentFeatureImage] = useState(defaultImg);
  const [currentBtnActive, setCurrentBtnActive] = useState(false);
  ...
  const setP1Img = () => {
    ...
    if (currentFeatureImage === p1Img) {
      setCurrentBtnActive(true);
    } else {
      setCurrentBtnActive(false);
    }
  };
  const setP2Img = () => {
    setCurrentFeatureImage(p2Img);
    if (currentFeatureImage === p2Img) {
      setCurrentBtnActive(true);
    } else {
      setCurrentBtnActive(false);
    }
            ...
            <div className="flex-1 p-10">
              <div>
                ...
                <div className="py-4">
                  <div
                    onClick={setP1Img}
                    // className="flex flex-row items-center text-4xl py-2 px-4 space-x-2 active:bg-slate-400/60 rounded-xl hover:bg-slate-400/50 cursor-pointer"
                    className={
                      currentBtnActive
                        ? "flex flex-row items-center text-4xl py-2 px-4 space-x-2 bg-slate-400/60 rounded-xl hover:bg-slate-400/50 cursor-pointer"
