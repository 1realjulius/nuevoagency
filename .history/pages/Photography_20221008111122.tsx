  ...
  return (
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular cursor-none z-10">
      ...
      <motion.div
        ...
        className={`${
          curVar === "default"
            ? "bg-black h-5 w-5 rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50"
            : " bg-white h-20 w-20 rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50 mix-blend-difference"
        }`}
      />
      {/* main */}
      <div className="px-4 md:px-16 pt-16">
        ...
        <div className="flex flex-col  w-full p-2">
          ...
          <h1
            ...
            className="text-4xl md:pt-10 md:text-8xl md:pr-20 font-FredokaOneRegular pt-6 pb-4"
          >
