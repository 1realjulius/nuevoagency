...
const Events = () => {
  ...
  return (
    <div className="main bg-[#161719] min-h-screen min-w-screen text-white flex flex-col font-FredokaOneRegular">
      {/* navbar */}
      ...
      <div className="px-4 md:px-16 pt-16">
        {/* heaer */}
        <div data-cursor="-hidden" className="flex flex-col  w-full p-2">
