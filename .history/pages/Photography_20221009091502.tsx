      ...
      <motion.div
        ...
        className={`${
          curVar === "default"
            ...
            : curVar === "btnHover"
            ? "bg-blue-400 h-10 w-10 rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50"
            ...
            >
              <Link href="/Contact">
                <div
                  className={` ${
                    curVar === "btnHover"
                      ? "px-4 py-2 bg-white text-black rounded-full cursor-none"
                      : "px-4 py-2 bg-blue-200 text-black rounded-full "
                  }`}
                >
