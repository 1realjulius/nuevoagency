      ...
      <div>
        ...
        <div className="">
          {AgencyCategories.map((Catslide, index) => (
            ...
            >
              {index === currentCategory && (
                <div className="relative grid grid-cols-2 py-20 md:px-20 items-center justify-center">
                  <div className="flex flex-col items-center justify-center p-10">
                    <div>
                      <div>
                        <h1 className="text-6xl">{Catslide.catSection}</h1>
                      </div>
                      <div>
                        <h1 className="text-4xl">what you get</h1>
                      </div>
                    ...
                    <div>
                      <div className="flex flex-row items-start space-x-6"></div>
                    </div>
                  </div>
                  <div className="p-10">
                    <div>
