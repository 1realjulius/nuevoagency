  ...
  return (
    <div className="bg-black min-h-screen min-w-screen text-white pb-20 flex flex-col">
      ...
      <div className="">
        ...
        <div className="p-2 py-10 flex flex-row items-center justify-center">
          ...
          <div className="flex-1 flex-col space-y-4 items-center justify-center md:pl-10 text-center">
            <div className="flex flex-row items-center space-x-2">
              ...
              <h1 className="flex flex-row items-center space-x-2 text-4xl font-semibold">
