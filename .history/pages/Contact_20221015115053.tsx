      ...
      <div className="px-4 md:px-40 md:pt-20 pt-16">
        ...
        <div>
          <div>
            <form
              action="submit"
              className="flex flex-col md:space-y-6 text-2xl"
            >
              <div className="py-4">
                <input
                  type="text"
                  className="border-b-4 border-[#828282] bg-white bg-inherit w-80 md:w-[80vw] p-2 md:py-4 outline-none"
                  // maxLength={256}
              ...
              <div className="py-4">
                <textarea
                  ...
                  className="border-b-2 border-[#828282] bg-inherit w-84 md:w-[40vw] p-2 pb-10 outline-none"
                  spellCheck="false"
                />
              </div>
              <div>
