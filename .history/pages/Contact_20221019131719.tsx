...
const Contact = () => {
  ...
  //checkform befor submitted

  const checkBeforeSubmit = () => {
    if (formData.senderID === senderID) {
      handleOnSubmit;
    } else {
  ...
  return (
    <div className="bg-black relative min-h-screen min-w-full text-white font-FredokaOneRegular select-none">
      ...
      {/* main */}
      <div className="px-4 md:px-40 md:pt-10 pt-6">
        {/* Hero text */}
        <div className="py-10">
          <div className="py-4">
            <h1 className="py-4 text-4xl md:text-7xl">
              <span>Have An Event! </span> <br />
              <span className="text-[#828282] text-2xl md:text-5xl py-2 pr-4 border-b-[3px] border-[#828282]">
                Tell Us About It
              </span>
            </h1>
          </div>
