  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        {/* slider section */}
        <div className="">
          {AgencyCategories.map((CatItem, index) => {
            <div
              className={`
          ${index === currentCategory && "overflow-hidden"}
            `}
              key={index}
            >
              {index === currentCategory && (
                <div className="relative py-20 md:px-20 flex flex-row items-center justify-centerr">
                  <div className="flex-1">
                    <div>
                      <div>
                        <h1>{CatItem.catSection</h1>
                      </div>
                      <div>
                        <h1>what you get</h1>
                      </div>
