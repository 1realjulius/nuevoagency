    ...
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        <div className="flex relative flex-row items-center justify-center min-h-[200px]">
          <div>
            <h1 className="text-9xl font-bold text-gray-400/10">START</h1>
          </div>
          <div className="absolute items-center justify-center flex flex-col px-80">
            <p className="text-base text-gray-400">
              GET YOUR BEAUTIFUL PICTUES AND AWSOME VIDEOS
            </p>
            <h1 className="text-4xl pb-4 pt-2">
              Are You Ready to take your awsome shots with us?
            </h1>
