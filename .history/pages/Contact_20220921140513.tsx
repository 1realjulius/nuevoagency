    ...
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div className="py-20 md:px-40">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center">
          <div className="flex flex-col items-center justify-center w-[300px] -[24px] border-2">
            <p className="text-lg">Call Me</p>
            <h1 className="text-xl">(+233) 549321512</h1>
          </div>
          <div className="flex flex-col items-center justify-center w-[300px] py-[24px] border-2">
