            ...
            <form action="submit" className="flex flex-col md:space-y-6">
              <div className="grid md:grid-cols-2 gap-2">
                <div>
                  <input
                    type="text"
                    className="border-b-2 border-[#828282] bg-inherit w-full md:w-[400px] p-2 outline-none"
                    // maxLength={256}
                ...
                <div>
                  <textarea
                    ...
                    className="border-b-2 border-[#828282] bg-inherit w-full md:w-[400px] p-2 pb-10 outline-none"
                    spellCheck="false"
                  />
                </div>
              </div>
