        ...
        <motion.div
          ...
          className={`${
            cursorVariant === "default"
              ? "bg-white h-[2px] w-[2px] rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50"
              : cursorVariant === "project"
              ? "bg-blue-400 h-[40px] w-[40px] rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50"
              : " bg-white h-24 w-24 rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50 mix-blend-difference"
          }`}
        >
          {cursorText && <h1>{cursorText}</h1>}
        </motion.div>
      </div>
      {/* navbar */}
              ...
              <Link href="/Contact">
                <div className="px-4 py-2 bg-white hover:bg-[#828282] hover:text-white text-black rounded-full cursor-pointer">
                  <h1 className="text-lg font-FredokaOneRegular flex flex-row items-center space-x-2">
                    ...
                    <span className="text-base">Book A Shoot</span>
                  </h1>
                </div>
              </Link>
            </div>
