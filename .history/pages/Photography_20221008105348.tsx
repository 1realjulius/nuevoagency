...
const Photography = () => {
  ...
  return (
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular cursor-none z-10">
      {/* navbar */}
      ...
      <motion.div
        ...
        className={`${
          curVar === "default"
            ? "bg-blue-200 h-5 w-5 rounded-full fixed top-0 left--events-none hidden md:block z-50"
            : curVar === "img"
            ? "bg-yellow-200 h-5 w-5 rounded-full fixed top-0 left--events-none hidden md:block z-50"
            : curVar === "text"
            ? " bg-white h-16 w-16 rounded-full fixed top-0 left--events-none hidden md:block z-50 mix-blend-difference"
            : "bg-green-200 h-5 w-5 rounded-full fixed top-0 left--events-none hidden md:block z-50"
        }`}
      />
      {/* main */}
                ...
                <div className="flex-1 py-2 md:pl-20 ">
                  <div className="relative">
                    ...
                    <div className="absolute -top-2 -right-2">
                      <Link href="#">
                        <div className="bg-white p-2 hover:bg-[#828282]  text-black hover:text-white rounded-full">
                          <Instagram className=" w-6 h-6 md:w-8 md:h-8" />
                        </div>
                      </Link>
                    </div>
