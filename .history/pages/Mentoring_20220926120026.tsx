...
const Mentoring = () => {
  const pFeatureImg = [
    ...
    { id: 2, igLink: "#", imgType: "Accra Fest", img: "/Assets/floss.png" },
    { id: 3, igLink: "#", imgType: "Fetu Fest", img: "/Assets/landscape.jpg" },
    { id: 4, igLink: "#", imgType: "Volta fest", img: "/Assets/moonrise.png" },
  ];
      ...
      <div className="px-6 md:px-16 pt-16">
        ...
        <div className="flex flex-col  w-full h-[72vh] md:h-[80vh] p-2">
          <h1 className="flex flex-row items-center space-x-2">
            ...
            <span className="text-xl font-bold">Mentoring</span>
          </h1>
        ...
        <div>
          ...
          <div className=" py-10 flex flex-col md:flex-row md:items-center md:justify-center">
