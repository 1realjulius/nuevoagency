      ...
      <div className="px-4 md:px-40 md:pt-20 pt-6">
        ...
        <div className="flex flex-col items-start justify-start">
          ...
          <div className="grid grid-cols-3 md:grid-cols-5 gap-2 py-4">
            ...
            <div
              ...
              className={`${
                checkWeddingActive
                  ? "flex flex-col items-center bg-white text-black border-2 border-transparent  rounded-full px-4 py-3"
        ...
        <div>
          <div>
            <form
              action="submit"
              className="flex flex-col md:space-y-8 text-3xl "
            >
              {/* User Name */}
              <div className="py-2 my-4 border-b-[3px] border-[#828282]">
                <input
                  type="text"
                  className=" w-80 md:w-[70vw] p-2 outline-none bg-inherit placeholder:text-[#828282]"
