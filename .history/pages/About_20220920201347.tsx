      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row  items-center justify-center">
          <div className="flex flex-row">
            <div className="border-t border-r border-l border-gray-600 p-6">
              <h1 className="text-6xl">100+</h1>
              <p>Projects Completed</p>
            </div>
            <div className="border-t border-r border-gray-600 p-6">
          ...
          <div className="flex flex-row">
            ...
            <div className="border-t border-r  border-gray-600 p-6 flex flex-col items-center">
