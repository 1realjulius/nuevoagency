  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        <div className="flex relative flex-row items-start justify-center min-h-[200px] md:min-h-[300px] max-w-screen overflow-auto py-20">
          <div className="flex flex-row">
            <div className="flex-1">
              <Link href="#">
      ...
      <div className="flex flex-col md:flex-row md:px-20 py-10">
        <div className="flex-1">
          <div className="space-y-2">
            ...
            <div className="flex flex-row items-center space-x-4 py-2 text-xl">
              <div>TW</div>
              <div>IG</div>
              <div>YT</div>
              <div>FB</div>
        ...
        <div className="flex-1 flex items-start">
          <div className="flex flex-col  space-y-4">
            <div className="flex flex-row items-center space-x-4 text-4xl font-medium">
              <div>Home</div>
              <div>Gallery</div>
              <div>Services</div>
              <div>About</div>
