...
const Photography = () => {
  ...
  const btnx = useSpring(200, { stiffness: 100, damping: 10 });
  const btny = useSpring(200, { stiffness: 100, damping: 10 });

  const rotateX = useTransform(btnx, [0, 400], [-45, 45]);
  const rotateY = useTransform(btny, [0, 400], [-45, 45]);
  ...
  const btnEnter1 = () => magnetbtn();
  const btnLeave1 = () => setCurVar("default");
  ...
  return (
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular z-10 ">
      ...
      <motion.div
        ...
        className={`${
          curVar === "default"
            ? "bg-black h-4 w-4 rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50"
            : curVar === "btnHover"
      ...
      <div className="px-4 md:px-16 pt-16">
        ...
        <div className="flex flex-col  w-full p-2">
          ...
          <div className="py-2 flex flex-row space-x-4 items-start">
            ...
            >
              <Link href="/Contact">
                <motion.div
                  ...
                  className={` ${
                    curVar === "btnHover"
                      ? "px-4 py-2  text-white bg-[#828282] rounded-full cursor-none"
            ...
            <motion.div onMouseEnter={btnEnter1} onMouseLeave={btnLeave1}>
              <Link href="#">
