  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        <div className="flex relative flex-row items-center justify-center min-h-[200px] py-10">
          <div>
        ...
        <div className="flex relative flex-row items-start justify-center min-h-[200px] md:min-h-[300px] max-w-screen overflow-auto">
          <div className="flex flex-row">
            <div className="flex-1">
              <Link href="#">
                <div className="relative flex flex-col items-center justify-center w-[200px] h-[200px] md:w-[300px] md:h-[300px]">
                  <Image
                    src="/Assets/moonrise.png"
                    layout="fill"
                    alt=""
                    className="absolute object-cover"
                  />
                  <div className="absolute items-center justify-center flex flex-col space-y-2">
                    <p>View on</p>
                    <h1 className="text-4xl leading-none pb-4">Instagram</h1>
                    <Instagram size={40} />
                  </div>
                </div>
              </Link>
