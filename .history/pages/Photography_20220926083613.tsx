  ...
  return (
    <div className="bg-black min-h-screen min-w-screen text-white flex flex-col">
      ...
      <div className="px-6 md:px-16 pt-16">
        {/* heaader */}
        <div className="flex flex-col  w-full h-[72vh] md:h-[60vh] p-2">
          ...
          <h1 className="text-4xl md:pt-10 md:text-6xl md:pr-20 font-bold pt-6 pb-6">
            <span>We Make Perfect Memories Out Of </span>
            <span className="text-[#828282]">Your Experiences With Photos</span>
          </h1>
          <div className="py-4 pt-6 md:pt-10 flex flex-col items-start">
            <div>
              <Link href="#">
          ...
          <div className="flex flex-col items-start pb-2">
            <div className="grid grid-cols-3">
              <div className="flex flex-col items-start justify-center pt-6 pb-6 pr-6">
