      ...
      <div>
        ...
        <div>
          <div className="flex flex-row items-center py-20">
            ...
            <div className="flex-1 p-10 justify-end">
              <div className="relative w-[400px] h-[600px] flex flex-col justify-end">
                <div>
                  <Image
                    src="/Assets/moonrise.png"
                    layout="fill"
                ...
                <div className="relative -left-40 -bottom-6 w-[400px] h-[600px]">
                  <Image
                    src="/Assets/moonrise.png"
                    layout="fill"
                    alt=""
