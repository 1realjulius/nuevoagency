    ...
    <div className="bg-black min-h-screen min-w-screen text-white flex flex-col">
      ...
      <div className="px-6 md:px-16 pt-16">
        ...
        <div>
          ...
          <div className=" py-10 flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="flex-1 flex-col space-y-4 items-center md:pl-10 text-center md:text-start">
