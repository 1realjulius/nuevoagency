      ...
      <div className="px-4 pt-8">
        ...
        <div className="">
          <div className="md:px-10">
            <h1 className="text-4xl md:pt-20 pt-10 md:text-8xl md:pr-20 font-FredokaOneRegular py-2">
              <span>Our </span>
        ...
        {/* Our Goals */}
        <div>
          <div className="flex flex-col md:flex-row md:px-16 py-10">
            <div className="flex-1 flex flex-col items-start px-2">
              <div className="border-b-[3px] border-[#828282] my-4 py-1 pr-2 ">
                <h2 className="text-sm md:text-2xl">Our Aims</h2>
              </div>
              <div>
            ...
            <div className="flex-1">kljasnd</div>
          </div>
        </div>
        {/* The Numbers */}
        <div>
          <div className="flex flex-row justify-between px-5 text-lg md:text-6xl md:px-40">
            <div>
              <div className="flex flex-col items-start justify-start pt-6 pb-6 ">
                <h1 className="text-4xl md:text-6xl font-FredokaOneRegular flex flex-row ">
                  <span>140</span>
