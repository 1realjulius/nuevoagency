...
const Photography = () => {
  ...
  const currentFeatureImg = [
    { id: 1, img1: "/Assets/bright-rain.png", img2: "/Assets/moonrise.png" },
    { id: 2, img1: "/Assets/moonrise.png", img2: "/Assets/landscape.jpg" },
    { id: 3, img1: "/Assets/landscape.jpg", img2: "/Assets/floss.png" },
    { id: 4, img1: "/Assets/floss.png", img2: "/Assets/bright-rain.png" },
  ];

  const [currentCategory, setCurrentCategory] = useState(0);
  const [currentFeatureImage, setCurrentFeatureImage] = useState("");
  const [currentFeatureImage2, setCurrentFeatureImage2] = useState("");
