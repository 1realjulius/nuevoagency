...
export default async function handler(
  ...
  res: NextApiResponse<Data>
    ...
    if (req.method === 'POST'){
        ...
        console.log(form.senderID,form.senderEmail)
         const msg = {
             to: 'iamjuliuseghan@icloud.com',
             from: 'support@webncos.com',
             subject:`NuevoStudios, New Client Message ${form.senderID}`,
             text:`
             ...
             html:`
             Client Name : ${form.senderName}<br/>
             Client Email : ${form.senderEmail}<br/>
             Client Interest : ${form.eventType}<br/>
             Client Budget : ${form.eventBudget}<br/>
             Client Message : ${form.senderMessage}`,
         }
         try {
