  ...
  return (
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular">
      ...
      <motion.div
        ...
        className={`${
          curVar === "default"
            ? "bg-blue-200 h-5 w-5 rounded-full fixed top-0 left-0 z-50 pointer-events-none"
            : curVar === "img"
            ? "bg-yellow-200 h-5 w-5 rounded-full fixed top-0 left-0 z-50 pointer-events-none"
            : curVar === "text"
            ? " bg-white h-16 w-16 rounded-full fixed top-0 left-0 z-50 pointer-events-none mix-blend-difference"
            : "bg-green-200 h-5 w-5 rounded-full fixed top-0 left-0 z-50 pointer-events-none"
        }`}
      />
      {/* main */}
