    ...
    <div className="bg-[#161719] min-h-screen min-w-full text-white font-FredokaOneRegular">
      ...
      <div className="px-4 pt-16">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-10 md:items-center md:justify-between">
            <div className="bg-pink-200 w-full h-full col-span-5 px-10">
              <div className="pt-4 bg-blue-200 ">
                <div className="">
                  <motion.img
                    ...
                    alt=""
                    className="object-cover h-[140px] w-[100vw] md:h-[200px] md:w-[100vw] rounded-xl"
                  />
                </div>
              </div>
            </div>
