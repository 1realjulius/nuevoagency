      ...
      <div className="px-4 md:px-16 pt-16">
        ...
        <div>
          <div className="flex flex-col pb-4 md:flex-row md:py-10">
            <div className="flex-1 py-2 md:pr-20 order-2 md:order-1 pr-2">
              <div className="relative">
                <motion.img
                  ...
                  alt=""
                  className="object-cover h-[300px] md:h-[400px] w-[100vw] md:w-[30vw] rounded-xl"
                />
                <motion.img
                  initial={{ y: 30, opacity: 0 }}
                  animate={{ y: 0, opacity: 1 }}
                  ...
                  alt=""
                  className="absolute -bottom-2 -right-2 object-cover h-[180px] md:h-[250px] w-[220px] md:w-[400px] rounded-xl"
                />
              </div>
            </div>
            <div className="flex-1 py-2 order-1 md:order-2">
              ...
              <div className="py-4 flex flex-row space-x-4 items-start">
                {/* Contact */}
                <Link href="/Contact">
                  <div className="bg-white hover:bg-[#828282] hover:text-white cursor-pointer text-black px-4 py-2 rounded-full flex flex-row items-center justify-center">
                    <h1 className="flex flex-row items-center space-x-2 md:text-xl font-FredokaOneRegular">
