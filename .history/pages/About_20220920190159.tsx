      ...
      <div>
        ...
        <div className="flex flex-col py-20">
          <div className="flex flex-col items-center">
            <h1 className="text-lg md:text-3xl text-center md:px-80 py-4">
          ...
          <div className="flex flex-col md:flex-row space-y-8  px-6 md:px-40">
            <div className=" flex-1">
              <div className="flex flex-col">
                <p>Awsome crafts Makings</p>
                <h1>Mind-Blowing Results</h1>
              ...
              <div className="flex justify-center items-center px-3 py-2 rounded-full border-2 border-white">
                <p>Request A Quota</p>
              </div>
            </div>
