  ...
  return (
    <div className="bg-black min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        <div className="">
          <div className="items-center justify-center flex flex-col md:flex-row pt-40 px-6">
            ...
            <div className="flex flex-1 items-center justify-center">
              <div className=" flex flex-col">
                <div className="flex flex-col space-y-4 md:px-40 text-base md:text-lg mb-8">
                  <h1>
