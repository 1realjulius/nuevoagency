...
const Photography = () => {
  ...
  return (
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular z-20 relative w-full">
      {/* navbar */}
      ...
      <div className="">
        <div className="relative px-4 md:px-16 pt-16">
          {/* heder */}
          <div className="flex flex-col  w-full py-2 pb-6 absolute top-0 inset-x-0">
          ...
          <div className="flex flex-col pt-8 py-4 md:pt-20 space-y-12 absolute top-0">
