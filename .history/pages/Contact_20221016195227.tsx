...
const Contact = () => {
  ...
  return (
    <div className="bg-black min-h-screen min-w-full text-white font-FredokaOneRegular overflow-y-hidden scrollbar-hide">
      {/* navbar */}
      <div className="sticky top-0 z-50 hidden">
        <NavBar />
      </div>
      {/* main */}
      <div className="px-4 md:px-40 md:pt-20 pt-6 overflow-y-visible overflow-hidden scrollbar-hide">
        {/* Hero text */}
        <div className="py-10">
          <div className="py-4">
