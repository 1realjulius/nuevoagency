...
const Photography = () => {
  ...
  return (
    <div className="relative bg-[#161719] min-h-screen min-w-full text-white overflow-hidden pb-20">
      {/* navbar */}
      ...
      <div>
        ...
        <div>
          <div className="flex flex-row">
            <div className="flex-1 px-20 ustify-end items-center">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="grid grid-cols-3 items-center justify-center">
            ...
            <div className=" w-50 h-36 border flex flex-col items-center justify-center">
              <div>
                <h1 className="text-7xl">100+</h1>
              </div>
              <div>
