...
const Photography = () => {
  ...
  return (
    <div className="relative bg-[#161719] min-h-screen min-w-full text-white pb-20">
      {/* navbar */}
      ...
      <div className="relative min-h-screen min-w-screen">
        <div>
          <motion.img
            ...
            // layout="fill"
            alt=""
            className=" absolute object-cover min-h-screen min-w-screen"
          />
        </div>
        <div className="absolute flex min-h-screen min-w-full items-center justify-center">
          <div className="flex flex-col items-center justify-center md:px-40 text-center">
            <h1 className="absolute top-10 text-xl font-bold py-4 flex flex-row items-center space-x-4">
      ...
      <div>
        ...
        <div className="">
          {AgencyCategories.map((Catslide, index) => (
            <div
              className={`
            ${index === currentCategory && "overflow-hidden relative"}
              `}
              key={index}
            >
        ...
        <div>
          <div className="flex flex-row">
            <div className="flex-1 px-20 justify-end items-center">
              {currentFeatureImage.map((cImage) => {
                return (
                  <div className="relative  top-0 flex flex-row items-end justify-end">
                    <div className="relative  w-[400px] h-[600px] right-0 flex flex-col ">
                      <Image
                        src={cImage ? cImage.img1 : "/Assets/moonrise.png"}
                        layout="fill"
                        alt=""
                        className=" absolute object-cover rounded-xl"
                      />
                    </div>
                    <div className="relative  bottom-0 -left-10 w-[400px] h-[400px]">
                      <Image
                        src={cImage ? cImage.img2 : "/Assets/moonrise.png"}
                        layout="fill"
                        alt=""
                        className=" absolute object-cover rounded-xl"
                      />
            ...
            <div className="flex-1 pb-20 pr-20">
              <div>
                ...
                <div className="flex flex-col items-start py-4 space-y-4">
                  <div
                    ...
                    className={
                      ActiveBtn === 1
                        ? "flex flex-row items-center text-4xl py-2 px-4 space-x-2 rounded-xl bg-slate-400/50 cursor-pointer"
                        : "flex flex-row items-center text-4xl py-2 px-4 space-x-2 active:bg-slate-400/60 rounded-xl hover:bg-slate-400/50 cursor-pointer"
                    }
                  >
                    {" "}
                    <span>
                  ...
                  >
                    ...
                    <span>Potraits 4</span>
                  </div>
                </div>
                <div className="flex items-center">
                  <Link href="/Contact">
                    <div className="px-8 py-2 rounded-md bg-white">
                      <h1 className="text-black text-2xl">Contact Us</h1>
                    </div>
                  </Link>
                </div>
              </div>
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <div className="grid grid-cols-3 items-center justify-center">
            <div className=" w-80 h-36 border flex flex-col items-center justify-center">
              <div className="py-2">
