  ...
  return (
    <div className="bg-black min-h-screen min-w-screen text-white flex flex-col font-FredokaOneRegular">
      ...
      <div className="px-4 md:px-16 pt-16">
        {/* heder */}
        <div className="flex flex-col  w-full p-2 pb-6">
          <h1 className="text-[40px] md:pt-10 md:text-8xl md:pr-20 font-FredokaOneRegular pt-6 pb-4 leading-none">
            <span>We Make Perfect Memories From Your Experiences </span>
