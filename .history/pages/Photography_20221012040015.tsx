                ...
                <div className="flex-1 py-2 md:pr-20 order-2 md:order-1">
                  <div className="relative">
                    <motion.img
                      ...
                      alt=""
                      className="object-cover h-[300px] md:h-[360px] w-[100vw] md:w-[80vw] rounded-xl"
                    />
                    <motion.img
                      initial={{ y: 30, opacity: 0 }}
                      animate={{ y: 0, opacity: 1 }}
                      ...
                      alt=""
                      className="absolute -bottom-2 -right-2 md:-bottom-4 md:-right-4 object-cover h-[150px] md:h-[220px] w-[200px] md:w-[400px] rounded-xl"
                    />
                  </div>
                </div>
