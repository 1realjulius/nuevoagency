...
const Photography = () => {
  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-screen text-white pb-20 flex flex-col">
      {/* navbar */}
      ...
      <div className="relative">
        <motion.img
          ...
          // layout="fill"
          alt=""
          className="object-cover h-[40vh] md:h-[80vh] w-[100vw]"
        />
        <div className="absolute top-0 flex h-[80vh] w-f[80vw] items-center justify-center">
