  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        <div className="flex relative flex-row items-start justify-center min-h-[200px] md:min-h-[300px] max-w-screen overflow-auto py-6">
          <div className="flex flex-row">
            <div className="flex-1">
              <Link href="#">
      ...
      {/* footer */}
      <div className="flex flex-col md:flex-row md:px-80">
        <div className="flex-1">
          <div>
            <p className="text-xl">Get In Touch</p>
            <h1 className="text-2xl">email@email.com</h1>
            <h1 className="text-2xl">+233 549321512</h1>
        ...
        <div className="flex-2">
          <div className="flex flex-col space-y-4">
            <div className="flex flex-row items-center space-x-4 text-xl font-medium">
              <div>Home</div>
              <div>Gallery</div>
              <div>Services</div>
              <div>About</div>
