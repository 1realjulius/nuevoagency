  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row md:px-40 py-20">
          <div className="flex-1">
            <div className="relative w-full px-2 h-[256px] md:w-[440px] md:h-[556px]">
              <Image
                src="/Assets/moonrise.png"
                layout="fill"
                alt=""
                className="absolute object-cover"
              />
              <div className="absolute bottom-0 h-[70px] bg-black/50 px-4 py-2">
