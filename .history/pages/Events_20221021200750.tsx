              ...
              <div className="m-2">
                <Link href="#">
                  <motion.div
                    ...
                    whileTap={{ scale: 1 }}
                    transition={{ ease: "easeOut", duration: 0.2 }}
                    className={` ${"px-4 py-2 border  md:text-xl text-white hover:bg-[#FF0000] hover:text-white rounded-full hover:border-transparent border-white cursor-pointer flex flex-row items-center space-x-2"}`}
                  >
                    <span>
