      ...
      <div className="px-4 md:px-16 pt-16">
        ...
        <div className="">
          ...
          <div className="">
            ...
            {/* contact us */}
            <div className="py-10">
              <div className="grid grid-col-3 gap-4 items-center justify-center">
                <div className="p-2 bg-white text-black col-span-2">
                  <div>
                    {/* img */}
                    <div>
                      <motion.img
                        ...
                        src="/Assets/moonrise.png"
                        alt=""
                        className="object-contain h-[50px] md:h-[80px] w-[50px] md:w-[80px] rounded-full"
                      />
                    </div>
                    {/* text */}
                    <div>
                ...
                <div className="p-10 bg-white text-black">2</div>
                <div className="p-10 bg-white text-black col-span-3">3</div>
              </div>
            </div>
          </div>
        </div>
