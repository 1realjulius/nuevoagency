...
const Photography = () => {
  ...
  const btnx = useSpring(10, { stiffness: 100, damping: 10 });
  const btny = useSpring(10, { stiffness: 100, damping: 10 });
      ...
      <div className="px-4 md:px-16 pt-16">
        ...
        <div className="flex flex-col  w-full p-2">
          ...
          <div
            ...
            className="py-2 flex flex-row space-x-4 items-start"
          >
            <motion.div
            ...
            <motion.div className="w-48 h-20 bg-slate-300 flex flex-col items-center justify-center">
              <motion.div
                style={{
                  x: rotateX,
                  y: rotateY,
