      ...
      <div className="px-4 md:px-16 pt-16">
        ...
        <div className="">
          ...
          <div className="">
            ...
            {/* contact us */}
            <div className="py-10">
              <div className="grid grid-col-3 md:grid-cols-5 gap-4 items-center justify-center">
                <div className="p-2 bg-white text-black col-span-2 md:col-span-2 rounded-md">
                  <div>
                    {/* img */}
                    <div>
                      <motion.img
                ...
                <div className="p-2 bg-white text-black rounded-md md:col-span-2 ">
                  <div>
                    {/* img */}
                    <div>
                      <motion.img
                ...
                <div className="p-2 bg-white text-black col-span-3 md:col-span-1 rounded-md">
                  <div>
                    {/* img */}
                    <div>
                      <motion.img
                ...
                <div className="p-2 hidden md:block bg-white text-black rounded-md">
                  <div>
                    {/* img */}
                    <div>
                      <motion.img
