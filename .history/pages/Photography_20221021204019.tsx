    ...
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular z-10 ">
      ...
      <div className="px-4 md:px-16 pt-16">
        ...
        <div className="flex flex-col pt-8 py-4 md:pt-20">
          ...
          <div className="relative h-[90vh] bg-blue-200">
            <div className="bg-pink-200 absolute top-0 left-0 w-full h-full flex-1">
              content
            </div>
            <div className="bg-green-200 absolute top-0 right-0 w-full h-full flex-1">
              images
            </div>
          </div>
        </div>
