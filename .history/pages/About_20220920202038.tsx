  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-full text-white">
      ...
      <div>
        ...
        <div className="flex relative flex-row items-center justify-center min-h-[200px] bg-blue-200">
          <div>
            <h1 className="text-9xl font-bold">START</h1>
          </div>
          <div className="absolute">kbabvlbajb</div>
        </div>
