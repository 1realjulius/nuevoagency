      ...
      <div className="px-4 md:px-40 md:pt-20 pt-6">
        ...
        <div>
          <div>
            ...
            >
              {/* User Name */}
              <div className="py-2 my-6 border-b-[3px] border-[#828282] bg-blue-300 w-80 md:w-[70vw]">
                <input
                  type="text"
              ...
              <div className="py-2 my-6 border-b-[3px] border-[#828282] bg-blue-300 w-full md:w-[70vw]">
                <textarea
