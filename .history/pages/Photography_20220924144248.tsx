              ...
              <div>
                ...
                <div className="py-4">
                  <div
                    ...
                    className={
                      currentFeatureImage === p1Img
                        ? "flex flex-row items-center text-4xl py-2 px-4 space-x-2 rounded-xl bg-slate-400/50 text-blue-400 cursor-pointer"
                        : "flex flex-row items-center text-4xl py-2 px-4 space-x-2 active:bg-slate-400/60 rounded-xl text-red-400 hover:bg-slate-400/50 cursor-pointer"
                    }
                  >
                    {" "}
                    <span>
