...
const Photography = () => {
  ...
  return (
    <div className="bg-[#161719] min-h-screen min-w-screen text-white pb-20 flex flex-col items-center justify-center">
      {/* navbar */}
      ...
      <div className="relative">
        <motion.img
          ...
          // layout="fill"
          alt=""
          className=" absolute object-cover h-[80vh] w-[100vw]"
        />
        <div className="absolute flex h-[80vh] w-f[80vw] items-center justify-center">
