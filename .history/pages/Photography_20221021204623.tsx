    ...
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular z-10 ">
      ...
      <div className="px-4 md:px-16 pt-16">
        ...
        <div className="flex flex-col pt-8 py-4 md:pt-20">
          ...
          <div>
            <div className="relative h-[90vh] bg-blue-200 flex flex-col md:flex-row">
              <div className="bg-pink-200 w-full h-full flex-1">content</div>
              <div className="bg-green-200 w-full h-full flex-1">images</div>
            </div>
          </div>
        </div>
      </div>
