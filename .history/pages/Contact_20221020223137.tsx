...
const Contact = () => {
  ...
  const handleEvents = (e: any) => {
    ...
    let wed = "";
    let bd = "";
    if (checked && ch === "Wedding") {
      //checked for wedding
      setWIsChecked(true);
      wed = ch;
      console.log(wed);
    } else if (!checked && ch === "Wedding") {
      //unchecked for wedding
      setWIsChecked(false);
      wed = "";
      console.log("wn");
    } else if (checked && ch === "Birthday") {
      //checked for Photography
      setBIsChecked(true);
      bd = ch;
      console.log(bd);
    } else {
    ...
    console.log("The Events are " + wed, bd);
  };
