  ...
  return (
    <div className="bg-black/50 flex flex-col items-center justify-center overflow-hidden text-white">
      {AgencyCategories.map((Catslide, index) => (
        <AnimatePresence key={Catslide.id}>
          <div
            className={`
            ${
              index === currentCategory &&
              "relative min-w-screen min-h-screen flex flex-col items-center"
            }
              `}
          >
            {index === currentCategory && (
              <div className="relative min-w-screen min-h-screen flex flex-col items-center">
                <div className="absolute top-16  h-[30vh] md:h-[24vh] w-[90vw] items-center justify-center p-2 z-10">
                  <div className="text-white text-xl font-bold relative w-full h-full  flex flex-col">
                    <div>
                      <motion.h1
                    ...
                    <div className="absolute bottom-0">
                      ...
                      <h1 className="text-secondarydark">This is a test</h1>
                    </div>
                  </div>
                </div>
                <div className="absolute bottom-5 z-10">
                  <div className="relative w-[90vw] h-[54vh] md:h-[64vh] flex flex-col items-center justify-center">
                    <div className="relative w-[90vw] h-[54vh] md:h-[64vh]">
                      <motion.img
                        layoutId="img"
                        ...
                        alt=""
                        className="absolute object-cover w-[90vw] h-[54vh] md:h-[64vh] rounded-xl"
                      />
                    </div>
                    <div className="bg-white p-2 rounded-full absolute -top-6 -right-2 shadow-lg">
                      <motion.h1
                    ...
                    <div className=" absolute bottom-2 right-2 flex flex-row items-center space-x-2">
                      <div
                        onClick={prevPSlide}
                    ...
                    <div className="absolute bottom-2 left-2">
                      <Link href={Catslide.catLink}>
                        <div className="bg-black/50 text-white px-5 py-2 rounded-full cursor-pointer">
                          <h1 className="flex flex-row items-center space-x-2 text-lg">
                            <span>Go to</span>
                            <motion.span
                              layoutId="catlink"
