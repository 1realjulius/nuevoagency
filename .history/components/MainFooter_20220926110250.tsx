...
const MainFooter = () => {
  return (
    <div className="relative">
      ...
      <div className="p-4 absolute top-0 flex flex-col items-center justify-center md:py-20 border-b rounded-b-lg border-white">
      ...
      {/* footer itseelf */}
      <div className="absolute bottom-0 px-6 py-4 md:pt-20 flex flex-col bg-[#828282]">
