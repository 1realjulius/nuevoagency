            ...
            {index === currentCategory && (
              <div className="relative min-w-screen min-h-screen flex flex-col items-center">
                ...
                <div className="absolute bottom-5 z-10">
                  <div className="relative w-[90vw] h-[46vh] md:h-[64vh] flex flex-col items-center justify-center">
                    <div className="relative w-[90vw] h-[46vh] md:h-[64vh]">
                      <motion.img
                        layoutId="img"
                        ...
                        alt=""
                        className="absolute object-cover w-[90vw] h-[46vh] md:h-[64vh] rounded-xl"
                      />
                    </div>
