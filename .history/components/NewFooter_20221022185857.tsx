    ...
    <div className="flex flex-col">
      <div className="grid md:grid-cols-3 bg-white text-black px-4 py-2">
        <div className="col-span-2 flex flex-row items-center">
          ...
          {/* Sunscribe Form */}
          <div className="bg-blue-200 p-2 w-full md:w-[50%] items-start">
            <div>
              <h1>Get Our Pckages and Prices</h1>
            </div>
            <div className="flex flex-col md:flex-row ">
              <label className="w-full bg-blue-400">
                <input
                  type="email"
                  name="Sunscribe_Email"
                  id=""
                  placeholder="Your Email"
                  className="bg-inherit text-black w-full p-2"
                />
              </label>
              <div className="px-4 py-2 w-full md:w-fit bg-green-300">
