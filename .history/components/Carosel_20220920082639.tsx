  ...
  return (
    <div>
      <div className="min-w-screen relative flex min-h-screen">
        ...
        {/* Top Section */}
        <div className="absolute top-6 flex w-full flex-row items-center justify-end px-6">
          {/* The logo */}
        ...
        {/* Down Section */}
        <div className="absolute bottom-4 flex w-full flex-row items-center justify-between px-4 text-white">
          {/* Social Media */}
