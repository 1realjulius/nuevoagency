              ...
              <motion.div key={Catslide.id}>
                {index === currentCategory && (
                  <motion.div className="grid md:grid-cols-2 gap-4">
                    {/* texts */}
                    <motion.div className="bg-pink-200 items-center justify-center p-2 z-10">
                      <motion.div className="text-white text-xl font-FredokaOneRegular w-full h-full items-center flex flex-col">
                        ...
                        <motion.div className="">
                          <motion.h1
                            ...
                            exit={{ y: -50, opacity: 0 }}
                            className="text-4xl md:text-6xl md:pr-20 uppercase"
                          >
