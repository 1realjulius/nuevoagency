          ...
          <div className="bg-green-200 flex flex-col items-center justify-center p-2">
            <div className="relative w-[90vw] h-[80vh] md:h-[90vh] bg-yellow-200 flex flex-col items-center justify-center p-2">
              ...
              <div className="absolute top-0 grid grid-cols-3 gap-2 w-full h-full">
                <div className="bg-blue-200 md:absolute top-0 left-1 col-span-2 h-[200px] w-[220px]">
                  of
                </div>
                <div className="bg-red-200 md:absolute top-0 right-0  h-[200px] w-[110px]">
                  2
                </div>
                <div className="bg-purple-200 md:absolute bottom-0 col-span-3 h-[350px] w-full">
                  3
                </div>
              </div>
              {/* hero text */}
