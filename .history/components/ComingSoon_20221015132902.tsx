                  ...
                  <div>
                    <Link href="/Contact">
                      <motion.div
                        ...
                        className={` ${
                          curVar === "btnHover"
                            ? "px-4 py-2  bg-white text-black rounded-full border-2 border-transparent"
                            : "px-4 py-2 border-2 border-white text-white rounded-full "
                        }`}
                      >
                        <h1>Book a shoot</h1>
                      </motion.div>
                  ...
                  <div>
                    <Link href="/Contact">
                      <motion.div
                        ...
                        className={` ${
                          curVar === "btn1Hover"
                            ? "px-2 py-2  bg-white text-black rounded-full border-2 border-transparent"
                            : "px-2 py-2 border-2 border-white text-white rounded-full "
                        }`}
                      >
