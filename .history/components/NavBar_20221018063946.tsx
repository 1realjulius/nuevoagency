...
const NavBar = () => {
  ...
  return (
    <div className="fixed top-3 right-3 overflow-hidden z-50">
      <div className="">
        <AnimatePresence>
          {open ? (
            ...
            <motion.div
              className={`${
                navColour
                  ? "flex flex-row items-center justify-center px-2 md:px-8 py-2 md:py-8 bg-white h-10 w-10 rounded-full"
                  : "flex flex-row items-center justify-center px-2 md:px-8 py-2 md:py-8 h-10 w-10 rounded-full"
              }`}
            >
              <div>
                {navColour ? (
