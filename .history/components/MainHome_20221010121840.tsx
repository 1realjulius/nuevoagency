                  ...
                  <div className="relative flex flex-col items-start justify-center">
                    ...
                    <div className="">
                      <motion.img
                        ...
                        alt=""
                        className="object-cover h-[200px] md:h-[600px] md:w-[80vw] w-[100vw] rounded-xl"
                      />
                    </div>
                    {/* lb */}
                    <div className="absolute left-4 md:right-0 bottom-0">
                      lb
                    </div>
                    {/* rb */}
                    <div className="absolute right-4">rb</div>
                    {/* igl */}
                    <div className="absolute bottom-4 right-4">ig</div>
                  </div>
                  <div></div>
                </div>
              )}
