      ...
      <div className="relative ">
        <div className="flex flex-col items-center justify-center">
          {PhotographyImages.map((Pslide, index) => (
            <div
              className={
                index === currentP ? "overflow-hidden" : " overflow-hidden"
              }
              key={index}
            >
              {index === currentP && (
      ...
      <div className="relative">
        <div className="flex flex-col items-center justify-center">
          {VideographyImages.map((Vslide, index) => (
            <div
              className={
                index === currentV ? "overflow-hidden" : "overflow-hidden"
              }
              key={index}
            >
              {index === currentV && (
      ...
      <div className="relative">
        <div className="flex flex-col items-center justify-center">
          {EventsImages.map((Eslide, index) => (
            <div
              className={
                index === currentE ? "overflow-hidden" : "overflow-hidden"
              }
              key={index}
            >
              {index === currentE && (
      ...
      <div className="relative">
        <div className="flex flex-col items-center justify-center">
          {MentoringImages.map((Mslide, index) => (
            <div
              className={
                index === currentM ? "overflow-hidden" : "overflow-hidden"
              }
              key={index}
            >
              {index === currentM && (
