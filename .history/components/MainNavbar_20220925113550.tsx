    ...
    <nav className="absolute w-full">
      <div className="">
        <div
          className={`${
            navColour
              ? "py-2 flex w-full flex-row items-center justify-between px-6 bg-gray-900/80"
              : "py-2 flex w-full flex-row items-center justify-between px-6"
          }`}
        >
          {/* The logo */}
          <Link href="/">
            <div className="md:hidden relative w-[140px] h-[44px] cursor-pointer">
              <Image
          ...
          <Link href="/">
            <div className="hidden md:block relative w-[140px] h-[44px] cursor-pointer">
              <Image
