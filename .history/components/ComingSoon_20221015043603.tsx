  ...
  return (
    <div className="w-[100vw] h-[100vh]">
      <div className="relative h-full w-full flex flex-col justify-end overflow-hidden">
        <div className="absolute top-[2px] left-[0px] w-full md:w-[50vw] p-4 h-full space-y-2">
        ...
        <div className="bg-white py-3 text-black flex flex-row justify-between px-4">
          <div>
            <h1>NuevoAgency</h1>
          </div>
          <div>
