...
const MainHome = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center overflow-hidden">
      <div className="sticky top-0 z-50 bg-[#161719]">
        <div
          className={`${
            navColour
              ? "absolute top-0 py-2 flex w-full flex-row items-center justify-end px-8 bg-[#161719]"
              : "absolute top-0 py-2 flex w-full flex-row items-center justify-end px-8"
          }`}
        >
          {/* The logo */}
