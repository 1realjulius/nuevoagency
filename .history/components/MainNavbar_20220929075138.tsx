    ...
    <nav className="absolute w-full">
      <div className="">
        <div
          className={`${
            navColour
              ? "py-2 pt-4  flex w-full flex-row items-center justify-between px-6 bg-[#828282] "
        ...
        >
          ...
          <div className="py-4">
            <Link href="/">
              <div className="md:hidden relative w-[20px] h-[20px] cursor-pointer">
                <Image
            ...
            <Link href="/">
              <div className="hidden md:block relative w-[60px] h-[28px] cursor-pointer">
                <Image
