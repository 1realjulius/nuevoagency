      ...
      <div className="min-w-screen relative flex min-h-screen">
        ...
        <div className="absolute top-4 flex w-full flex-row items-center justify-between px-6">
          ...
          <div className="flex flex-row items-center space-x-3">
            {/* Bookings */}
            <div className="rounded-full border-2 border-white px-3 py-2 flex items-center justify-center pb-1 text-white">
              <h1 className="text-xl leading-none">Bookings</h1>
            </div>
            {/* Nav Menu */}
            <div>
              <div>
