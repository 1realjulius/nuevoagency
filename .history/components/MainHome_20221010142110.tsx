  ...
  return (
    <div className="text-white bg-black flex flex-col font-FredokaOneRegular z-10 min-h-screen">
      ...
      <main className="h-[100vh] flex flex-col items-center justify-center px-4">
        {/* hero text */}
        <div className="relative bg-green-200 h-[90vh] w-full flex flex-col items-center justify-center">
          ...
          <div className="absolute bottom-4 right-4">
            <div className="border-4 border-white rounded-full w-16 h-16 flex flex-col items-center justify-center">
              <p>h1</p>
            </div>
          </div>
        </div>
