            ...
            {index === currentCategory && (
              ...
              >
                <motion.div className="absolute top-16  h-[30vh] md:h-[24vh] w-[90vw] items-center justify-center p-2 z-10">
                  <motion.div className="text-white text-xl font-bold relative w-full h-full  flex flex-col">
                    <motion.div className="flex flex-row items-center space-x-2">
                      <motion.div className="p-1 bg-white rounded-full">
                        <motion.span
                ...
                <motion.div className="absolute bottom-5 z-10">
                  <motion.div className="relative w-[90vw] h-[46vh] md:h-[54vh] flex flex-col items-center justify-center">
                    <motion.div className="relative w-[90vw] h-[46vh] md:h-[54vh]">
                      <motion.img
                        layoutId="img"
                        ...
                        alt=""
                        className="absolute object-cover w-[90vw] h-[46vh] md:h-[54vh] rounded-xl"
                      />
                    </motion.div>
