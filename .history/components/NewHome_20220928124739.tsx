              ...
              <motion.div key={Catslide.id}>
                {index === currentCategory && (
                  <motion.div className="grid md:grid-cols-2 gap-4">
                    {/* texts */}
                    <motion.div className="text-white text-xl flex flex-col space-y-2 items-start h-full">
                      {/* cat link and btn */}
                      <div className="flex flex-row items-center w-full justify-between">
                        {/* cat link */}
                        <h1>jbsdjklads</h1>
                        <h1>
                          <span>{currentCategory + 1}</span>
                        </h1>
                      </div>
                      {/* Main hero text */}
                        ...
                        <div className="py-2">
                          <Link href={Catslide.catLink}>
                            <motion.div
                              ...
                              whileTap={{ scale: 0.9 }}
                              className="px-3 py-1 bg-white text-black rounded-xl cursor-pointer text-lg md:text-2xl flex flex-row items-center space-x-2"
                            >
                              <h1>View</h1>
