...
const MainHome = () => {
  ...
  const videographyVieos = [
    {
      ...
      vidStyle: "h-[200px] md:h-[280px] w-[100vw]",
    ...
    },
    {
      ...
      vidStyle: "h-[224px] md:h-[280px] w-[100vw]",
  ...
  return (
    <main className="bg-black min-h-[100vh] min-w-[100vw] m-0">
      <section className="w-[100%] h-[100vh] snap-y snap-mandatory scroll-smooth overflow-y-scroll overflow-hidden scrollbar-hide scroll-smooth">
        {/* childern */}
        <div>
          <NavBar />
        </div>
        ...
        <section className="bg-black w-[100vw] h-[100vh] snap-start p-2">
          <div className="w-full h-full relative text-white overflow-hidden">
            {/* bg images */}
            <div className="absolute -top-[160px] md:-top-[300px] left-0 md:-left-0 rotate-[30deg] z-10">
        ...
        <section className="bg-black w-[100vw] h-[100vh] snap-start p-4">
          <div className="w-full h-full flex flex-col">
            <div className="flex flex-col md:flex-row h-full items-center justify-between">
              ...
              <div className="w-full  h-full bg-blue-200">Content</div>
            </div>
          </div>
        </section>
        {/* Events Section */}
