  ...
  return (
    <div className="  md:px-10">
      ...
      <div className="p-4 flex flex-col items-center justify-center">
        <div className="bg-[#242424] w-[90vw] md:w-[40vw] relative flex flex-col p-4 rounded-xl font-bold">
          ...
          <div className="">
            <Link href="#">
              <div className="bg-white text-black px-5 py-2 rounded-lg flex flex-row items-center ">
                <h1>Contact Us</h1>
              </div>
            </Link>
          </div>
