        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          <div className="flex flex-col md:flex-row md:space-x-4 font-bold">
            ...
            <div className="flex flex-row space-x-4 py-2">
              <div>
                <Link href="#">
                  <h1 className="text-2xl md:text-4xl">Photography</h1>
                </Link>
              </div>
              <div>
                <Link href="#">
                  <h1 className="text-2xl md:text-4xl">Videography</h1>
                </Link>
              </div>
            </div>
            <div className="flex flex-row items-center  space-x-4 py-2">
              <div>
                <Link href="#">
                  <h1 className="text-2xl md:text-4xl">Events</h1>
                </Link>
              </div>
              <div>
                <Link href="#">
                  <h1 className="text-2xl md:text-4xl">Mentoring</h1>
                </Link>
              </div>
            </div>
          </div>
