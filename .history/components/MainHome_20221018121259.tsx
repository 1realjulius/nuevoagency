      ...
      <main className="bg-black min-h-[100vh] min-w-[100vw] m-0">
        <section className="w-[100%] h-[100vh] snap-y snap-mandatory overflow-y-scroll overflow-hidden scrollbar-hide scroll-smooth">
          ...
          <motion.div
            ...
            className={`${
              cursorVariant === "default"
                ...
                ? "bg-green-200 h-[10px] w-[10px] rounded-full fixed top-0 left-0 pointer-events-none hidden md:block z-50"
          ...
          <section className="bg w-[100vw] h-[100vh] snap-start ">
            <div className="w-full bg-white text-black h-full flex flex-col items-center justify-center">
              {/* about text */}
              <div>
