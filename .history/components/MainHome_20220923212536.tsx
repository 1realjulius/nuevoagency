...
const MainHome = () => {
  ...
  const VideographyImages = [
    ...
    },
    {
      ...
      heroText: "This is for Videographyimage 4",
    },
    {
      id: 5,
      Vimage: "/Assets/Julius_Eghan.jpg",
      heroText: "This is for Videographyimage 5",
    },
  ];
  const EventsImages = [
    {
    ...
    },
    {
      ...
      heroText: "This is for Eventimage 4",
    },
    {
      id: 5,
      Eimage: "/Assets/Julius_Eghan.jpg",
      heroText: "This is for Eventimage 5",
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center justify-center overflow-hidden">
            ...
            <div
              className={
                index === currentP
                  ...
                  : " overflow-hidden transition duration-100"
              }
              key={index}
            >
              {index === currentP && (
          ...
          {VideographyImages.map((Vslide, index) => (
            <div
              className={
                index === currentV
                  ? "overflow-hidden relative w-screen h-screen"
                  : "overflow-hidden slide transition duration-100"
              }
              key={index}
            >
              {index === currentV && (
      ...
      <div className="relative">
        <div className="flex flex-col items-center justify-center">
          {VideographyImages.map((Eslide, index) => (
            <div
              className={
                index === currentE
                  ? "overflow-hidden relative w-screen h-screen"
          ...
          <div className="absolute bottom-6 right-8">
            <div className="flex flex-row items-center justify-between space-x-6">
              <div onClick={prevESlide} className="p-1 bg-white rounded-full">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
              ...
              <div onClick={nextESlide} className="p-1 bg-white rounded-full">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
