...
const NewFooter = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="grid md:grid-cols-3 gap-0 bg-white text-black px-2 py-2">
        {/* email Subscribe */}
        ...
        {/* Contact Section */}
        <div className="col-span-2 md:border-l-[3px] p-2 flex flex-col w-full bg-green-300 md:px-2 md:py-4">
          <div className="flex flex-col justify-between w-full bg-blue-200">
            <div>
            ...
            <div className="bg-[#E5E7EB] w-full ">
              <Link href="/Contact">
                <div>
                  <h1 className="text-xl">Tell Us About It</h1>
                </div>
              </Link>
            </div>
          </div>
