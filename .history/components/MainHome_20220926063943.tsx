        ...
        {AgencyCategories.map((Catslide, index) => (
          <div>
            {index === currentCategory && (
              ...
              >
                <motion.div className="absolute top-16  h-[30vh] md:h-[24vh] w-[90vw] items-center justify-center p-2 z-10">
                  <motion.div className="text-white text-xl font-bold relative w-full h-full  flex flex-col">
                ...
                <motion.div className="absolute bottom-5 z-10">
                  <motion.div className="relative w-[90vw] h-[46vh] md:h-[64vh] flex flex-col items-center justify-center">
                    <motion.div className="relative w-[90vw] h-[46vh] md:h-[64vh]">
                      <motion.img
                        layoutId="img"
                    ...
                    <motion.div className="bg-white p-2 rounded-full absolute -top-6 -right-2 shadow-lg"></motion.div>
