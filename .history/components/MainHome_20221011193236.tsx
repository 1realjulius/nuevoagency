        ...
        <div className="min-h-screen w-full flex flex-col pt-16">
          <div className="bg-green-200 relative flex flex-col items-center justify-center p-2">
            <div className="relative w-[90vw] h-[80vh] md:h-[90vh] bg-yellow-200 flex flex-col items-center justify-center p-2">
              {/* hero bg images */}
              <div className="absolute top-0 grid grid-cols-3 h-full w-full gap-2 ">
                <div className="bg-blue-200 col-span-2 h-[400px]">of</div>
                <div className="bg-red-200 h-[400px]">2</div>
