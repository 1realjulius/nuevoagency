    ...
    <nav className="absolute w-full">
      <div className="">
        <div
          className={`${
            navColour
              ? "py-2 pt-4  flex w-full flex-row items-center justify-between px-6 bg-gray-900/80"
              : "py-2 pt-4 flex w-full flex-row items-center justify-between px-6 bg-white"
          }`}
        >
          {/* The logo */}
          <Link href="/">
