          ...
          <Dialog as="div" className="relative z-50" onClose={closeModal}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center text-center">
                ...
                >
                  <Dialog.Panel className="relative w-full min-w-screen min-h-screen transform overflow-hidden bg-black/50  transition-all">
                    ...
                    <div className="flex flex-col md:flex-row items-center  min-h-screen min-w-screen text-white">
                      <div className="flex-1 md:text-start md:pl-20 order-2 md:order-1">
                      ...
                      <div className="flex-1 order-1 md:order-2 pt-[100px] md:pt-0">
