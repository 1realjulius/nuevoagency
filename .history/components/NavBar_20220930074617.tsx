          ...
          {open ? (
            <div className="z-50 min-h-screen min-w-full overflow-hidden">
              <motion.div
                ...
                className="relative bg-green-200 min-w-full min-h-screen flex flex-col items-center justify-center"
              >
                <div className="absolute top-0 bg-pink-200 w-full py-2 px-8 flex flex-row items-center justify-between">
                  <div>hsvhjb</div>
                  <div>
                    {" "}
