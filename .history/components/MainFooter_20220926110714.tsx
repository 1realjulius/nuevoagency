...
const MainFooter = () => {
  return (
    <div className="relative">
      ...
      <div className="p-4 flex flex-col items-center justify-center md:py-20">
      ...
      <div className="h-10 relative bg-white">
        <div className="absolute top-0 h-4 bg-blue-300">haa</div>
      </div>
      {/* footer itseelf */}
      <div className="px-6 py-4 md:pt-20 flex flex-col bg-[#828282]">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          <div className="flex flex-col font-bold">
            <div className="flex flex-row space-x-4 py-2">
              ...
              <div>
                <Link href="#">
                  <h1 className="text-2xl md:text-5xl">Services</h1>
                </Link>
              </div>
            </div>
            <div className="flex flex-col md:flex-row md:space-x-4">
              <div className="flex flex-row space-x-4 py-2">
                <div>
                  <Link href="#">
                    <h1 className="text-2xl md:text-5xl">Photography</h1>
                  </Link>
                </div>
                <div>
                  <Link href="#">
                    <h1 className="text-2xl md:text-5xl">Videography</h1>
                  </Link>
                </div>
              </div>
              <div className="flex flex-row items-center  space-x-4 py-2">
                ...
                <div>
                  <Link href="#">
                    <h1 className="text-2xl md:text-5xl">Mentoring</h1>
                  </Link>
                </div>
              </div>
            </div>
