            ...
            {HeroImg.map((hero, index) => (
              <div key={hero.id}>
                {index === currentCategory && (
                  <div className="bg-green-200 p-2 relative flex flex-col items-start justify-center">
                    <div className="absolute left-4 bg-pink-200">h</div>
                    <div className="absolute right-4 bg-pink-200">h</div>
                    <div className="absolute bottom-2 right-4 bg-pink-200">
                      h
                    </div>
                    <div className="absolute bottom-2 left-4 bg-pink-200">
                      h
                    </div>
