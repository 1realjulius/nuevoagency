        ...
        <AnimatePresence>
          {open ? (
            <div className="z-50 min-h-screen min-w-full overflow-hidden">
              <motion.div className="relative bg-[#161719] bg-transparent min-w-full min-h-screen flex flex-col items-center justify-center overflow-hidden p-6 py-10">
            ...
            <motion.div
              className={`${
                navColour
                  ? "flex flex-row items-center justify-between px-4 md:px-8 py-2 bg-[#AFAFAF]"
