              ...
              <motion.div key={Catslide.id}>
                {index === currentCategory && (
                  <motion.div className="grid md:grid-cols-2 gap-4">
                    {/* texts */}
                    <motion.div className="text-white text-xl flex flex-col space-y-2 items-start justify-between h-full md:pl-10">
                      {/* cat link and btn */}
                        ...
                        <div className="py-2">
                          <Link href={Catslide.catLink}>
                            <motion.div
                              ...
                              whileTap={{ scale: 0.9 }}
                              className="px-3 py-1 md:px-5 md:py-2 bg-white text-black rounded-full cursor-pointer text-xl flex flex-row items-center space-x-2"
                            >
                              <h1>View</h1>
