                ...
                {index === currentCategory && (
                  <div>
                    <div className="bg-green-200 p-2 relative flex flex-col items-start justify-center">
                      <div className="z-10 flex flex-col items-start justify-center w-full h-full">
                        ...
                        <div className="absolute bottom-4 right-4 bg-pink-200">
                          h
                        </div>
                      </div>
                      <div className="md:px-40">
                        <motion.img
                          ...
                          src={hero.img}
                          alt=""
                          className="object-cover h-[50vh] w-[100vw] rounded-xl -z-10"
                        />
                      </div>
                    </div>
