      ...
      <div className="min-w-screen relative flex min-h-screen">
        ...
        <div className="absolute bottom-6 flex w-full flex-row items-center justify-between px-6 text-white text-lg">
          ...
          <div className="flex flex-row items-center space-x-6">
            <Link href="#">
              <div className="flex items-center justify-center rounded-full p-2 hover:bg-gray-200 hover:text-black cursor-pointer transition hover:duration-700">
                Tw
              </div>
            </Link>
            <Link href="#">
              <div className="flex items-center justify-center rounded-full w-[24px] h-[24px] hover:bg-gray-200 hover:text-black cursor-pointer transition hover:duration-700">
                Fb
              </div>
            </Link>
            <Link href="#">
