  ...
  return (
    <div className="w-[100vw] h-[100vh]">
      <div className="relative h-full w-full flex flex-col justify-end overflow-hidden">
        <div className="absolute top-[2px] left-[1px] w-full md:w-[50vw] p-2 h-full space-y-2">
          <div className="grid grid-cols-2  md:grid-cols-2 gap-2 md:gap-4 h-64 w-full z-10">
            {bgImages.map((img) => (
              <div
                key={img.id}
                className={`${img.imgContainerStyle} flex flex-col`}
              >
                <motion.img
        ...
        <div className="z-20 absolute bottom-10 left-0 md:top-0 md:right-2 md:text-end">
          <div>
            {/* herotext */}
            <motion.div
              initial={{ y: -30, opacity: 0 }}
