      ...
      <div className="flex flex-col items-center justify-center ">
        ...
        <div>
          <AnimatePresence mode="sync">
            {open && (
              <div className="fixed top-0 right-0 w-full min-h-screen bg-black z-30 text-white overflow-hidden">
                <motion.div
                ...
                >
                  <div className="flex flex-col items-center justify-between h-full">
                    ...
                    <div className="flex flex-col  w-full">
                      <div>jlbfl</div>
                      <div className="bg-neutral-900 py-10 pb-6 md:pb-10 px-4">
                        <div className="">
                          ...
                          <Link href="/Contact">
                            <h2 className="py-2 cursor-pointer">
                              <span className="border-b-2 text-2xl text-[#828282] hover:text-white hover:border-white border-[#828282] pr-2 py-2">
                                Tell Us About It
                              </span>
                            </h2>
                          </Link>
