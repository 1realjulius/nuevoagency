      ...
      <div className="flex flex-col items-center justify-center ">
          ...
          <div className="w-6 flex justify-end items-center">
            ...
            >
              ...
              <span
                className={`h-[2px] w-full bg-white  rounded-lg cursor-pointer transform transition duration-300 ease-in-out mix-blend-difference
                ${
                  openBtn ? "-rotate-45 -translate-y-3 bg-black text-black" : ""
                }
                `}
              />
            </div>
        ...
        <div className="">
          <AnimatePresence mode="sync">
            {open && (
              <div className="fixed top-0 right-0 w-full md:w-[50vw] min-h-screen bg-blue-200 z-30 text-black overflow-hidden md:border-l-[6px] ">
                <motion.div
