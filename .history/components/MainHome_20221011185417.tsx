  ...
  return (
    <div className="text-white flex flex-col font-FredokaOneRegular z-10 min-h-screen">
      ...
      <main className="flex flex-col items-center justify-center px-4">
        {/* hero text */}
        <div className="min-h-screen bg-purple-100 w-full flex flex-col pt-16">
          <div className="bg-green-200 relative flex flex-col items-center justify-center">
            <div className="relative w-[90vw] h-[80vh] md:h-[90vh] bg-yellow-200">
              ...
              <div className=" grid grid-cols-3 h-full w-full">
                <div className="bg-blue-200 col-span-2">1</div>
                <div className="bg-blue-200">2</div>
                <div className="bg-blue-200 col-span-3">3</div>
              </div>
            </div>
          </div>
        </div>
