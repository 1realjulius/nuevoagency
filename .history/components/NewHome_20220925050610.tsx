        ...
        >
          {index === currentCategory && (
            <div className="relative min-w-screen min-h-screen flex flex-col items-center">
              <div className="absolute top-16  h-[24vh] w-[90vw] items-center justify-center z-10">
                <div className="text-white text-xl font-semibold relative w-full h-full  flex flex-col">
                  <div>
