  ...
  return (
    <div className="bg-[#161719] flex flex-col overflow-hidden text-white font-FredokaOneRegular">
      <div className="px-4 md:px-16 pt-12">
        <div className="pt-2">
          <div className="pt-2">
            <h1 className="text-4xl md:text-8xl md:pr-20 font-FredokaOneRegular pt-4 pb-4 uppercase">
                      ...
                      <div className="flex flex-row items-center justify-between w-full">
                        ...
                        <div className="py-2">
                          <Link href={Catslide.catLink}>
                            <motion.div
                              ...
                              whileTap={{ scale: 0.9 }}
                              className="px-5 py-2 bg-white text-black rounded-full cursor-pointer text-xl flex flex-row items-center space-x-2"
                            >
                              <h1>View</h1>
                        ...
                        <div className=" flex flex-row items-center  space-x-2 md:space-x-4">
                          <motion.div
                            ...
                            whileTap={{ scale: 0.9 }}
                            onClick={prevPSlide}
                            className="bg-white text-black p-1 md:p-2 rounded-full cursor-pointer"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 20 20"
