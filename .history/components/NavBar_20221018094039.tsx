  ...
  return (
    <div className="overflow-hidden w-full z-40 flex">
      <div className="flex flex-col items-center justify-center ">
        ...
        <div
          className={`fixed top-3 right-3 z-40 flex flex-col items-center justify-center
            ${open ? "p-3" : "p-3"}
            ${menuColour ? "bg-white " : ""}
          `}
        >
        ...
        <div>
          {open && (
            <div className="fixed top-0 w-full min-h-screen bg-black/80 z-30 text-white">
              <motion.div
              ...
              >
                <div>haa</div>
                <div className="absolute bottom-2">haaaaaa</div>
              </motion.div>
            </div>
          )}
        </div>
