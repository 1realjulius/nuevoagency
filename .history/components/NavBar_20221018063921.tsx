        ...
        <AnimatePresence>
          {open ? (
            ...
            <motion.div
              className={`${
                navColour
                  ? "flex flex-row items-center justify-center px-2 md:px-8 py-2 md:py-8 bg-white h-10 w-10"
                  : "flex flex-row items-center justify-center px-2 md:px-8 py-2 md:py-8 h-10 w-10"
              }`}
            >
              <div>
                {navColour ? (
