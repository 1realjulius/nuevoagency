        ...
        <Transition appear show={isOpen} as={Fragment}>
          <Dialog as="div" className="relative z-50" onClose={closeModal}>
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <div className="fixed inset-0 bg-[#161719] bg-opacity-80" />
            </Transition.Child>
              ...
              <div className="flex min-h-full items-center justify-center text-center">
                ...
                >
                  <Dialog.Panel className="relative w-full min-w-screen min-h-screen transform overflow-hidden bg-black  transition-all">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center  min-h-screen min-w-screen pl-6 text-white">
                      <div className="flex-1 text-start md:pl-20 order-2 md:order-1">
                        <div className="my-4 space-y-2">
                          ...
                          <h2 className="text-base text-slate-600">
                            Professional Photgrapher film maker based in Ghana,
                            Accra.
                          </h2>
                        </div>
                        ...
                        <div className="my-4">
                          ...
                          <div className="flex flex-row items-center space-x-3 my-4">
                            <div>IG</div>
                            <div>TW</div>
                            <div>FB</div>
                          </div>
                      ...
                      <div className="flex-1 flex-col order-1 md:order-2 pt-[100px] md:pt-0">
                        <div className="text-4xl md:text-6xl text-start  font-bold space-y-8">
