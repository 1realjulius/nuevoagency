                ...
                {index === currentCategory && (
                  <motion.div className="grid md:grid-cols-2 gap-4">
                    ...
                    <motion.div className="">
                      <motion.div className="relative w-[80vw] h-[34vh] md:h-[56vh] flex flex-col items-center justify-center">
                        <motion.div className="">
                          <motion.img
                            layoutId="img"
                            ...
                            alt=""
                            className="absolute top-0 left-0 object-cover w-[80vw] h-[34vh] md:h-[56vh] rounded-xl"
                          />
                        </motion.div>
