                ...
                <div>
                    ...
                    <div className="flex flex-col justify-between">
                      ...
                      <div>
                        <div className="py-4 pt-6 md:pt-6 flex flex-row space-x-4 items-start">
                          ...
                          <div>
                            <Link href="#">
                              <div className="px-4 py-2 border-2 border-black hover:bg-black hover:text-white text-black rounded-full cursor-pointer">
                  ...
                  <div className=" h-[45vh] md:h-[56vh] ">
                    <div className="relative h-full w-full z-20">
                      ...
                      <div className="absolute -top-2 -left-2 bg-white rounded-full w-10 h-10 flex flex-col items-center justify-center border-2 border-gray-300">
