    ...
    <div className="bg-[#161719] text-white flex flex-col font-FredokaOneRegular z-10 ">
      ...
      <div className="px-4 md:px-16 pt-16 py-10">
        ...
        <div className="flex flex-col  w-full p-2 relative">
          <h1 className="text-4xl md:pt-10 md:text-8xl md:pr-20 font-FredokaOneRegular pt-6 pb-8">
            <span className="">We Make Perfect </span>
            <span className="text-[#828282]">Memories </span>
            <span className="">Out Of Your </span>
            ...
            <div>
              {index === currentCategory && (
                <div className="flex flex-col">
                  ...
                  <div className="relative flex flex-row items-center justify-between px-2 py-4">
                    <div>
                      <h1>
      ...
      {/* Photography */}
      <div className="min-h-screen w-full py-16 px-2">
          ...
          <div className="flex-1">
            <div className="">
              <motion.img
                ...
                alt=""
                className="object-cover h-[200px] md:h-[80vh] w-[100vw]"
              />
            </div>
          </div>
          <div className="flex-2 bg-blue-200">
            <div className="absolute right-4">jalsn</div>
            <div className="">jalsn</div>
          </div>
        </div>
      </div>
      {/* footer */}
