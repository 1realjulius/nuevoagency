...
const NewHome = () => {
  ...
  return (
    <div className="bg-[#161719] flex flex-col text-white font-FredokaOneRegular">
      <div className="px-6 md:px-16 pt-16">
        <div className="py-2">
          <div className="p-2">
            ...
            <div className="py-2 pt-2 flex flex-row space-x-4 items-start">
              <div>
                <Link href="/Contact">
              ...
              <motion.div key={Catslide.id}>
                {index === currentCategory && (
                  <motion.div className="grid md:grid-cols-2 gap-4">
                    {/* texts */}
                    <motion.div className="items-center justify-between p-2 z-10">
                      <motion.div className="text-white text-xl flex flex-col">
                        {/* hero texts and icon */}
