          ...
          <div className="bg-green-200 relative flex flex-col items-center justify-center">
            <div className="relative w-[90vw] h-[80vh] md:h-[90vh] bg-yellow-200 flex flex-col items-center justify-center">
              ...
              <div className="absolute grid grid-cols-3 h-full w-full gap-2 ">
                <div className="bg-blue-200 col-span-2 relative h-[400px] w-full">
                  <motion.img
                    src="/Assets/bright-rain.png"
                    alt=""
                    className="object-cover absolute h-[40vh] w-[100vw]"
                  />
                </div>
                <div className="bg-red-200 relative h-full w-full">
                  <motion.img
                    src="/Assets/bright-rain.png"
                    alt=""
                    className="object-cover absolute h-[260px] md:h-[350px] w-[100vw]"
                  />
                </div>
                <div className="bg-amber-200 col-span-3 relative h-full w-full">
                  <motion.img
                    src="/Assets/bright-rain.png"
                    alt=""
                    className="object-cover absolute h-[260px] md:h-[350px] w-[100vw]"
