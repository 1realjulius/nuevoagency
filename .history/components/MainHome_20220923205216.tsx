...
const MainHome = () => {
  ...
  const VideographyImages = [
    { id: 1, Vimage: "/Assets/bright-rain.png" },
    { id: 2, Vimage: "/Assets/floss.png" },
    { id: 3, Vimage: "/Assets/moonrise.png" },
    { id: 4, Vimage: "/Assets/landscape.jpg" },
    { id: 5, Vimage: "/Assets/Julius_Eghan.jpg" },
  ];
  const EventsImages = [
    { id: 1, Eimage: "/Assets/bright-rain.png" },
    { id: 2, Eimage: "/Assets/floss.png" },
    { id: 3, Eimage: "/Assets/moonrise.png" },
    { id: 4, Eimage: "/Assets/landscape.jpg" },
    { id: 5, Eimage: "/Assets/Julius_Eghan.jpg" },
  ];
  const MentoringImages = [
    { id: 1, Mimage: "/Assets/bright-rain.png" },
    { id: 2, Mimage: "/Assets/floss.png" },
    { id: 3, Mimage: "/Assets/moonrise.png" },
    { id: 4, Mimage: "/Assets/landscape.jpg" },
    { id: 5, Mimage: "/Assets/Julius_Eghan.jpg" },
  ];
        ...
        <div className="flex flex-col items-center justify-center">
          {PhotographyImages.map((Pslide, index) => (
            <div
              className={
                index === currentP
                  ? "overflow-hidden flex flex-col items-center justify-center relative w-screen h-screen"
              ...
              {index === currentP && (
                <div>
                  ...
                  <div className="absolute bottom-20 ">
                    <h1 className="text-white">{Pslide.heroSubTitle}</h1>
                  </div>
                </div>
              )}
            </div>
