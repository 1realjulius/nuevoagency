          ...
          >
            {index === currentCategory && (
              <div className="relative min-w-screen min-h-screen flex flex-col items-center">
                <div className="absolute top-16  h-[24vh] w-[90vw] items-center justify-center p-2 z-10">
                  <div className="text-white text-xl font-bold relative w-full h-full  flex flex-col">
                    <div>
                      <motion.h1>{Catslide.catSection}</motion.h1>
                    </div>
                ...
                <div className="absolute bottom-5 z-10">
                  <div className="relative w-[90vw] h-[64vh] flex flex-col items-center justify-center">
                    <div className="relative w-[90vw] h-[64vh]">
                      <motion.img
                        ...
                        // priority
                        alt=""
                        className="absolute object-cover w-[90vw] h-[64vh] rounded-xl"
                      />
                    </div>
                    <div className="bg-white p-2 rounded-full absolute -top-6 -right-2 shadow-lg">
                      <h1 className="text-black">{Catslide.catIcon}</h1>
                    </div>
