              ...
              <motion.div key={Catslide.id}>
                {index === currentCategory && (
                  <motion.div className="grid md:grid-cols-2 gap-4">
                    {/* texts */}
                    <motion.div className="text-white text-xl flex flex-col space-y-2 items-start h-full justify-between">
                      {/* cat link and btn */}
                      ...
                      <motion.div className="pl-2">
                        <h1 className="text-3xl md:text-7xl uppercase">
                    ...
                    <motion.div className="">
                      <motion.div className="relative w-[90vw] h-[34vh] md:h-[60vh] flex flex-col items-center justify-center">
                        <motion.div className="">
                          <motion.img
                            layoutId="img"
                            ...
                            alt=""
                            className="object-cover w-[90vw] h-[34vh] md:h-[60vh] rounded-xl"
                          />
                        </motion.div>
                        <div className="absolute -top-1 -left-1">
                          <Link href={Catslide.catLink}>
                            <motion.div
                              whileHover={{ scale: 1.1 }}
                              whileTap={{ scale: 0.9 }}
                              className="px-3 py-1 bg-white text-black rounded-xl cursor-pointer text-lg flex flex-row items-center space-x-2"
                            >
                              <span>View</span>
