    ...
    <div className="text-white flex flex-col font-FredokaOneRegular z-10 min-h-screen">
      ...
      <main className="flex flex-col items-center justify-center px-4">
        ...
        <div className="min-h-screen w-full flex flex-col pt-16">
          <div className="bg-green-200 relative flex flex-col items-center justify-center p-2">
            <div className="relative w-[90vw] h-[80vh] md:h-[90vh] bg-yellow-200">
              {/* hero bg images */}
              <div className="absolute top-0 grid grid-cols-3 gap-2 w-full h-full">
                ...
                <div className="bg-purple-200 md:absolute bottom-0 col-span-3 h-[400px] w-full">
                  3
                </div>
              </div>
              {/* hero text */}
