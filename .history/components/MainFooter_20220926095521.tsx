...
const MainFooter = () => {
  return (
    <div className="  md:px-10">
      ...
      <div className="px-4">
        <div className="flex relative flex-row items-center justify-center min-h-[200px] w-screen py-20">
          <div>
            <h1 className="text-7xl rotate-90 absolute right-0 md:text-[200px] leading-none font-bold text-gray-400/10">
              START
            </h1>
          </div>
