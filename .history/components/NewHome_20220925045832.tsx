        ...
        >
          {index === currentCategory && (
            <div className="relative min-w-screen min-h-screen flex flex-col items-center">
              <div className="absolute top-16  h-[30vh] w-[90vw] items-center justify-center  bg-gray-500 z-10">
                <div className="text-white text-xl font-semibold relative w-full h-full bg-red-400  flex flex-col">
                  <div>
                    <h1>{Catslide.catSection}</h1>
                  </div>
                  <div>
                    <h1 className="text-[50px] ">{Catslide.catHeroText}</h1>
                  </div>
                </div>
              </div>
              <div className="absolute bottom-5 z-10">
                <div className="relative w-[90vw] h-[60vh] flex flex-col items-center justify-center">
                  ...
                  <div className="bg-white p-2 rounded-full absolute -top-6 -left-2 shadow-lg">
