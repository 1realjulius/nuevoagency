      ...
      <div className="px-6 md:px-16 pt-16">
        <div className="py-2">
          <div className="bg-blue-200 p-2">
            ...
            <div className="py-4 pt-6 md:pt-6 flex flex-row space-x-4 items-start bg-red-200">
              <div>
                <Link href="/Contact">
                  <div className="px-4 bg-white hover:bg-[#828282] hover:text-white text-black rounded-full cursor-pointer">
