...
const NavBar = () => {
  ...
  return (
    <div className="fixed top-0 overflow-hidden w-full z-50">
      <div className="">
        <AnimatePresence>
          {open ? (
            ...
            <motion.div
              className={`${
                navColour
                  ? "flex flex-row items-end justify-end px-4 md:px-8 py-2 bg-[#828282]/95"
                  : "flex flex-row items-end justify-end px-4 md:px-8 py-2"
              }`}
            >
              <div>
                {navColour ? (
