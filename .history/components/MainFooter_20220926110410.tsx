...
const MainFooter = () => {
  return (
    <div className="relative">
      ...
      <div className="p-4 flex flex-col items-center justify-center md:py-20 border-b rounded-b-3xl border-white -bottom-10">
      ...
      {/* footer itseelf */}
      <div className="px-6 py-4 md:pt-20 flex flex-col bg-[#828282] -inset-4">
