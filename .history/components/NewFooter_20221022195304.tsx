...
const NewFooter = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="grid md:grid-cols-3 bg-white flex-row text-black px-2 py-2">
        {/* email Subscribe */}
        ...
        {/* Contact Section */}
        <div className="md:border-l-[3px] p-2 flex flex-row w-full bg-green-300 md:px-2 md:py-4">
