        ...
        {AgencyCategories.map((Catslide, index) => (
          <>
            {index === currentCategory && (
              ...
              >
                <motion.div className="absolute top-16  h-[46vh] md:h-[38vh] w-[90vw] items-center justify-center p-2 z-10 bg-yellow-200">
                  <motion.div className="text-white text-xl font-bold relative w-full h-full items-center flex flex-col">
                    <motion.div className="absolute top-0 left-0 flex flex-row items-center space-x-2">
                      <motion.div className="bg-white/50 rounded-full p-1">
                        <motion.span
                    ...
                    <div className="absolute bottom-0 left-0 px-3 py-2 bg-white/50 text-black rounded-full">
