    ...
    <nav className="absolute w-full">
      <div className="">
        <div
          className={`${
            navColour
              ? "py-1 pt-2  flex w-full flex-row items-center justify-between px-4 md:px-4 bg-[#242424] shadow-2xl"
              : "py-1 pt-2 flex w-full flex-row items-center justify-between px-4 md:px-4 bg-inherit"
          }`}
        >
          {/* logo */}
          <div className="">
            ...
            {navColour ? (
              <Link href="/">
                <div className="relative w-[160px] h-[40px] cursor-pointer">
                  <Image
