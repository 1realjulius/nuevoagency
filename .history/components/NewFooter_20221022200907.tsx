...
const NewFooter = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 bg-white text-black px-2 pt-2 md:py-2">
        {/* email Subscribe */}
        ...
        {/* Contact Section */}
        <div className="col-span-1 md:border-l-[3px] p-2 flex flex-col w-full md:px-2 md:pt-2">
          <div className="flex flex-col justify-between h-full w-full">
            <div className="px-2 py-2">
              <h1 className="text-2xl md:text-6xl">Have An Event !</h1>
            </div>
            <div className="flex flex-row space-x-2 items-center px-2 py-1">
            ...
            <div className="bg-[#E5E7EB] w-full p-2 rounded-lg md:rounded-none">
              <Link href="/Contact">
                <div className="md:pt-4 pt-2 flex flex-row items-center justify-between">
                  <h1 className="text-xl md:text-4xl text-[#828282] hover:text-black">
