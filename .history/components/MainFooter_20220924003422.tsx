  ...
  return (
    <div className="">
      ...
      <div className="flex flex-row items-center justify-center p-4 space-x-4">
        <Link href="#">
          <div className="relative group flex flex-col items-center justify-center w-[100px] h-[100px] cursor-pointer">
            <Image
        ...
        <Link href="#">
          <div className="relative group flex flex-col items-center justify-center w-[300px] h-[100px] cursor-pointer">
            <Image
        ...
        <Link href="#">
          <div className="relative group flex flex-col items-center justify-center w-[200px] h-[200px] cursor-pointer">
            <Image
        ...
        <div className="flex flex-col items-center justify-center px-4">
          <div className="flex flex-col items-center justify-center py-4">
            ...
            <div className="flex flex-col items-start justify-start py-2">
              <Link href="#">
                <div className="px-5 py-2 rounded-md bg-white text-black cursor-pointer">
                  <h1>Contact Us</h1>
                </div>
              </Link>
            </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-row items-center justify-center space-x-4 py-2">
              <Link href="#">
                <div className="cursor-pointer">
                  <h1 className="text-3xl text-white">Photography</h1>
                </div>
              </Link>
              <Link href="#">
                <div className="cursor-pointer">
                  <h1 className="text-3xl text-white">Videography</h1>
                </div>
              </Link>
              <Link href="#">
                <div className="cursor-pointer">
              ...
              <Link href="#">
                <div className="cursor-pointer">
                  <h1 className="text-3xl text-white">Mentoring</h1>
                </div>
              </Link>
            </div>
            <div className="flex flex-row items-center justify-center space-x-4 py-2">
              <h4 className="text-white">©2022 Nuevo Agency.</h4>
            </div>
          </div>
        </div>
      </div>
