          ...
          {open ? (
            <div className="z-50 min-h-screen min-w-full overflow-hidden">
              <motion.div
                ...
                className="relative bg-[#161719] min-w-full min-h-screen flex flex-col items-center overflow-hidden"
              >
                <div className="absolute top-0 w-full py-2 px-8 flex flex-row items-center justify-between overflow-hidden">
                  <div>
                    <Link href="/">
                ...
                <div className="py-10 bg-white w-full h-full">
                  <div className="flex flex-col items-center justify-center">
                    <h1 className="cursor-pointer">close</h1>
                  </div>
                </div>
              </motion.div>
            </div>
