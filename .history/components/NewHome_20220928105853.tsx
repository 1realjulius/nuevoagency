            ...
            {AgencyCategories.map((Catslide, index) => (
              <motion.div key={Catslide.id}>
                {index === currentCategory && (
                  <motion.div className="relative min-w-screen min-h-screen flex flex-col items-center">
                    <motion.div className="items-center justify-center p-2 z-10">
                      <motion.div className="text-white text-xl font-FredokaOneRegular relative w-full h-full items-center flex flex-col">
                        ...
                        <div className=" absolute bottom-0 right-0 flex flex-row items-center space-x-2">
                          <motion.div
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.9 }}
                            onClick={prevPSlide}
                    ...
                    <motion.div className="z-10">
                      <motion.div className="flex flex-col items-center justify-center">
                        <motion.div className=" w-[90vw] h-[36vh] md:h-[50vh]">
                          <motion.img
                            layoutId="img"
