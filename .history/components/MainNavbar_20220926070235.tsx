        ...
        <div
          className={`${
            navColour
              ...
              : "py-1 flex w-full flex-row items-center justify-between px-6 "
          }`}
        >
          {/* The logo */}
          <Link href="/">
          ...
          <div className="flex flex-row items-center space-x-9">
            {/* Bookings */}
            <div className="rounded-full border-2 border-white px-5 py-2 flex items-center justify-center text-white cursor-pointer">
              <h1 className="text-base leading-none">Bookings</h1>
            </div>
            {/* Nav Menu */}
            <div>
              <div>
