        ...
        <div className="col-span-2 flex flex-row items-center">
          ...
          <div className="p-2 w-full md:w-[50%] items-start">
            ...
            <div className="flex flex-col md:flex-row ">
              {/* user Email */}
              <div className="bg-[#E5E7EB] flex flex-row items-center text-lg w-full md:w-[70vw] rounded-lg">
                <input
                  type="email"
                  name="SenderEmail"
                  onChange={(event: any) => {
                  ...
                  className="w-full p-2 py-3 outline-none bg-black placeholder:text-[#828282]"
              ...
              <div className="py-1 my-2 md:my-0 flex flex-col ">
                <button
                  type="submit"
                  className="py-3 px-4 w-full md:w-fit bg-green-300 text-lg"
                >
                  Submit
                </button>
              </div>
